...
namespace PayrollApplication
{
    public class Constants
    {
        ...
        public const string MSG_APPLICATION_EXIT_CONFIRM_QUESTION = "ARE YOU SURE YOU WANT TO EXIT THIS APPLICATION?";
        public const string MSG_FORM_CLOSING = "FORM CLOSING....";
